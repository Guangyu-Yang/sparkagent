...
from myautoagent.bus import MessageBus, OutboundMessage
from myautoagent.channels.base import BaseChannel
from myautoagent.config import Config
...
class TelegramChannel(BaseChannel):
    ...
    def __init__(self, config: Config, bus: MessageBus):
        ...
        self._media_dir = Path.home() / ".myautoagent" / "media"
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm MyAutoAgent.\nSend me a message!"
        )
