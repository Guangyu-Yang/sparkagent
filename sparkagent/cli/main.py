...
def onboard():
    ...
    from sparkagent.config import Config, save_config, get_config_path
    ...
    console.print(f"\n🤖 SparkAgent is ready!")
    console.print("\nNext steps:")
    console.print("  1. Add your API key to [cyan]~/.sparkagent/config.json[/cyan]")
    console.print("  2. Chat: [cyan]sparkagent chat -m \"Hello!\"[/cyan]")
...
def chat(
    ...
    if not api_key:
        ...
        console.print("Add one to ~/.sparkagent/config.json under providers.openrouter.api_key")
        raise typer.Exit(1)
...
def status():
    ...
    from sparkagent.config import load_config, get_config_path
